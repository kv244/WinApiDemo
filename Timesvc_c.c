...
/* Standard interface: Timesvc, ver. 1.0,
 ...
 extern const MIDL_STUBLESS_PROXY_INFO Timesvc_ProxyInfo;
    ...
    /* [string][out] */ wchar_t szTime[ 64 ])
{
    ...
    _RetVal = NdrClientCall3(
                  ( PMIDL_STUBLESS_PROXY_INFO  )&Timesvc_ProxyInfo,
                  0,
                  0,
                  szTime);
...
static const MIDL_STUB_DESC Timesvc_StubDesc = 
    ...
    0x2000001, /* MIDL flag */
    0, /* cs routines */
    (void *)& Timesvc_ProxyInfo,   /* proxy/server info */
    0
    };
#ifdef __cplusplus
}
...
static const MIDL_STUBLESS_PROXY_INFO Timesvc_ProxyInfo =
    {
    &Timesvc_StubDesc,
    Timesvc__MIDL_ProcFormatString.Format,
    Timesvc_FormatStringOffsetTable,
